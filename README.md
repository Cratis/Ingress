...
If you prefer to browse the code in VSCode, you can do so by clicking [here](https://vscode.dev/github/einari/ingress).

## Contributing / Running locally

If you're looking to either contribute or dive into the code by building and running Cratis Ingress locally,
you can read more [here](./Documentation/index.md).